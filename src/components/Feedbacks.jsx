...
const FeedbackCard = ({ index, testimonial, name, designation, company, image}) => (
  ...
  >
    ...
    <div className="mt-1">
      ...
      <div className="mt-7 flex justfy-between items-center gap-1">
        <div className="flex flex-1 flex-col">
          <p className="text-white font-medium text-[16px]"><span className="blue-text-gradient">@</span><span>{name}</span></p>
